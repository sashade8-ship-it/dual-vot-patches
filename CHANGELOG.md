...
* Update the pre-release base to [Morphe Patches 1.44.0-dev.13](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.44.0-dev.13).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.44.0-dev.12-dualvot.8.5.3 (2026-09-20)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.44.0-dev.12](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.44.0-dev.12).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.44.0-dev.8](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.44.0-dev.8).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.44.0-dev.7-dualvot.8.5.3 (2026-09-19)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.44.0-dev.7](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.44.0-dev.7).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Fix videos and Shorts failing to load, followed by an app crash when
...
* Derive headers and cache-key parameter registers from the constructor
  signature. This supports their move from p6/p11 to p7/p12 in
  YouTube 21.37 while retaining compatibility with earlier builds.
* Copy high parameter registers below v16 before the injected invoke so
  the generated bytecode remains valid.
* Confirmed on an Android device with YouTube 21.37.42: regular videos
  and Shorts load normally, and swiping between Shorts no longer crashes.
