## 1.41.0-dev.12-dualvot.8.3 (2026-09-01)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.41.0-dev.12](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0-dev.12).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.41.0-dev.11-dualvot.8.3 (2026-08-31)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.41.0-dev.11](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0-dev.11).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.41.0-dev.10-dualvot.8.3 (2026-08-31)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.41.0-dev.10](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0-dev.10).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.41.0-dev.6](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0-dev.6).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.41.0-dev.4](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0-dev.4).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.41.0-dev.2](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0-dev.2).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
