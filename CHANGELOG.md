...
* Update the pre-release base to [Morphe Patches 1.45.0-dev.17](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.17).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.45.0-dev.16-dualvot.8.5.3 (2026-09-26)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.45.0-dev.16](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.16).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.45.0-dev.15-dualvot.8.5.3 (2026-09-25)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.45.0-dev.15](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.15).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.45.0-dev.13](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.13).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.45.0-dev.8](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.8).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.45.0-dev.7-dualvot.8.5.3 (2026-09-23)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.45.0-dev.7](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.7).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.45.0-dev.4](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.4).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.45.0-dev.3-dualvot.8.5.3 (2026-09-22)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.45.0-dev.3](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.45.0-dev.3).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the stable base to [Morphe Patches 1.44.0](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.44.0).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.43.0-dualvot.8.5.3 (2026-09-17)

### YouTube 21.37 playback compatibility

* Fix regular videos and Shorts failing to load, followed by an app crash when
  swiping to the next Short, on YouTube 21.37.42.
* Resolve the media-request URI, HTTP method, and body from the shared
  DataSpec fingerprint instead of obsolete obfuscated field names.
* Derive headers and cache-key parameter registers from the constructor
  signature, supporting their move from p6/p11 to p7/p12 while preserving
  compatibility with earlier YouTube versions.
* Copy high parameter registers below v16 before the injected invoke so the
  generated bytecode remains valid.
* Confirmed on an Android device with YouTube 21.37.42: regular videos and
  Shorts load normally, and swiping between Shorts no longer crashes.

## 1.43.0-dualvot.8.5.2 (2026-09-14)

### Automated Morphe update

* Update the stable base to [Morphe Patches 1.43.0](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.43.0).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the stable base to [Morphe Patches 1.42.0](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.42.0).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the stable base to [Morphe Patches 1.41.0](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.41.0).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the stable base to [Morphe Patches 1.40.0](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
