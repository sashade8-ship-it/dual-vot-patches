## 1.40.0-dev.22-dualvot.8.3 (2026-08-24)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.22](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.22).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.21-dualvot.8.3 (2026-08-23)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.21](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.21).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.40.0-dev.19](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.19).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.18-dualvot.8.3 (2026-08-22)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.18](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.18).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.17-dualvot.8.3 (2026-08-22)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.17](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.17).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.40.0-dev.14](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.14).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.40.0-dev.10](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.10).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.9-dualvot.8.3 (2026-08-18)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.9](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.9).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
...
* Update the pre-release base to [Morphe Patches 1.40.0-dev.7](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.7).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.6-dualvot.8.3 (2026-08-14)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.6](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.6).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.5-dualvot.8.3 (2026-08-13)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.5](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.5).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.4-dualvot.8.3 (2026-08-12)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.4](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.4).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.3-dualvot.8.3 (2026-08-11)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.3](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.3).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.

## 1.40.0-dev.2-dualvot.8.3 (2026-08-10)

### Automated Morphe update

* Update the pre-release base to [Morphe Patches 1.40.0-dev.2](
  https://github.com/MorpheApp/morphe-patches/releases/tag/v1.40.0-dev.2).
* Preserve Google/other and Yandex voice-over translation, mutual exclusion,
  volume controls, and automatic reset when the video changes.
* Build and structural Dual VoT checks passed before publication.
