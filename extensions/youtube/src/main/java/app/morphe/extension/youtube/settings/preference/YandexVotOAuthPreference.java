...
import app.morphe.extension.youtube.patches.voiceovertranslation.yandex.YandexVotApiClient;
import app.morphe.extension.youtube.patches.voiceovertranslation.yandex.YandexVotAuthWebViewDialog;
...
public class YandexVotOAuthPreference extends Preference implements Preference.OnPreferenceClickListener {
    ...
    private boolean isSignedIn() {
        String token = Settings.DUAL_VOT_YANDEX_OAUTH_TOKEN.get();
    ...
    private void showManualTokenDialog(Context context) {
        ...
        String currentToken = Settings.DUAL_VOT_YANDEX_OAUTH_TOKEN.get();
    ...
    private void onTokenObtained(@NonNull String token, long expiresIn) {
        ...
        Utils.runOnBackgroundThread(() -> {
            ...
            // Save the token
            Settings.DUAL_VOT_YANDEX_OAUTH_TOKEN.save(token);
    ...
    private void signOut() {
        Settings.DUAL_VOT_YANDEX_OAUTH_TOKEN.save("");
